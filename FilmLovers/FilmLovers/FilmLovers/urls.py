...
from authy.views import UserProfile, ReviewDetail, like, unlike, UserProfileMoviesWatched, UserProfileSeriesWatched, UserProfileWatchList, UserProfileMoviesReviewd
...
urlpatterns = [
    ...
    path('<username>/reviewed', UserProfileMoviesReviewd, name='profile-reviewed-list'),
